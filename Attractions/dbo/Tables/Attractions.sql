CREATE TABLE [dbo].[Attractions] (
	...
	[IsUserPersonalRequest] [bit] NULL,
    CONSTRAINT [PK_Attractions] PRIMARY KEY CLUSTERED ([AttractionsId] ASC),
    CONSTRAINT [FK_Attractions_MasterCity] FOREIGN KEY ([CityId]) REFERENCES [dbo].[MasterCity] ([CityId]),
    CONSTRAINT [FK_Attractions_MasterRank] FOREIGN KEY ([RankId]) REFERENCES [dbo].[MasterRank] ([RankId])
);
