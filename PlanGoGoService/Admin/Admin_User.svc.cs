...
{
    // NOTE: You can use the "Rename" command on the "Refactor" menu to change the class name "Admin_User" in code, svc and config file together.
    // NOTE: In order to launch WCF Test Client for testing this service, please select Admin_User.svc or Admin_User.svc.cs at the Solution Explorer and start debugging.
    public class Admin_User : BaseReference, IAdminUser
    {
