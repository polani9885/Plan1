...
export class Validations {
    ...
    public tripNameInfo() {
        try {
            ...
            if (!validationError) {
                ...
                let userTripId: number = 0;
                let angularScope: any = angular.element(document.getElementById('divTourPlan')).scope();
                ...
                TourInfo.prototype.userAddUpdateTourName($("#txtTripName").val(), userTripId, $("#ddlCountry").val());
            } else {
                $("#lblTourError").show();
            }
        } catch (e) {
            Validations.prototype.errorParameters = {};
            Error.prototype.logError("Validations",
                "tripNameInfo",
                Validations.prototype.errorParameters,
                e);
        }
    ...
    public loginValidation() {
        ...
        try {
            ...
            if (!validationError) {
                User.prototype.loginCheck($("#txtLoginUsername").val(), $("#txtLoginUsername").val());
            }
        } catch (e) {
            Validations.prototype.errorParameters = {};
            Error.prototype.logError("Validations",
